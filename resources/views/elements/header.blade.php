        ...
        <ul class="navbar-nav header-right">
          ...
          <li class="nav-item dropdown header-profile">
            <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
              <img src="{{ asset('images/avatar') }}/{{ Auth::user()->avatar_url }}" style="object-fit: cover;" width="20" alt=""/>
              <div class="header-info">
                <span class="text-black"><strong>{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</strong></span>
                <p class="fs-12 mb-0">{{ Auth::user()->level }}</p>
              </div>
            </a>
