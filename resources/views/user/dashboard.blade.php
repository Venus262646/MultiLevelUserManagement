            ...
            <div class="card-body">
              <div class="media align-items-center">
                ...
                <div class="media-body">
                  <h5>Te Pertenece</h5>
                  <p class="fs-14 mb-2">(this month)</p>
                  <span class="title text-black font-w600">{{ $users_count[ 'this_month' ] }} users</span>
                </div>
              </div>
              <div class="progress" style="height:5px;">
                <div class="progress-bar bg-success" style="width: {{ ($users_count[ 'sum' ] != 0)?(100 * $users_count[ 'this_month' ] / $users_count[ 'sum' ]):100 }}%; height:5px;" role="progressbar">
            ...
            <div class="card-body">
              <div class="media align-items-center">
                ...
                <div class="media-body">
                  <h5>Tu Creaste</h5>
                  <p class="fs-14 mb-2">(this month)</p>
                  <span class="title text-black font-w600">{{ $directs_this_month_count }} users</span>
                </div>
              </div>
              <div class="progress" style="height:5px;">
                <div class="progress-bar bg-secondary" style="width: {{ (count($directs) != 0)?(100 * $directs_this_month_count/count($directs)):100 }}%; height:5px;" role="progressbar">
                  <span class="sr-only">42% Complete</span>
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
              <div class="media align-items-center">
                ...
                <div class="media-body">
                  ...
                  <span class="title text-black font-w600">{{ $users_count[ 'sum' ] }} users</span>
                </div>
              </div>
              <div class="progress" style="height:5px;">
            ...
            <div class="card-body">
              <div class="media align-items-center">
                ...
                <div class="media-body">
                  <h5>Tu Creaste</h5>
                  <p class="fs-14 mb-2">(total)</p>
                  <span class="title text-black font-w600">{{ count($directs) }} users</span>
                </div>
              </div>
              <div class="progress" style="height:5px;">
      ...
      <div class="card">
        <div class="card-header d-sm-flex d-block pb-0 border-0">
          <div class="mr-auto pr-3 mb-sm-0 mb-3">
            <h4 class="text-black fs-20">User Chart</h4>
            <p class="fs-13 mb-0 text-black">It shows how many users are in each level under your hierachy</p>
          </div>
      ...
      <div class="card">
        <div class="card-header d-sm-flex d-block pb-0 border-0">
          <div class="mr-auto pr-3">
            <h4 class="text-black font-w600 fs-20">Users Created By You</h4>
            <p class="fs-13 mb-0 text-black">You can control these people</p>
          </div>
        </div>
        <div class="card-body pt-2">
          ...
          <div class="testimonial-one owl-carousel">
            ...
            <div class="items">
              <div class="card text-center">
                <div class="card-body">
                  <img src="{{ asset('images/avatar') }}/{{ $user->avatar_url }}" alt="">
                  <h5 class="fs-16 font-w500 mb-1"><a href="{!! url('/profile/'.$user->id); !!}" class="text-black">{{$user->first_name." ".$user->second_name}}</a></h5>
                  <p class="fs-14">{{ $user->email }}</p>
                  <div class="d-flex align-items-center justify-content-center">
                    ...
                    <span class="fs-14 d-block ml-2 pr-2 mr-2 border-right text-black font-w500">5.0</span> --}}
                    <a href="{!! url('/profile/'.$user->id); !!}" class="btn-link fs-14">View Profile</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          @else
            <p>There are no users created by you</p>
          @endif
        </div>
      </div>
    </div>
...
@push('scripts')
	<script>
      ...
      var options = {
          series: [{
            name: "Number",
            data: @json(array_values( $chart_users ))
          }
        ],
          chart: {
          height: 400,
        ...
        xaxis: {
          categories: @json(array_keys( $chart_users )),
            labels: {
              style: {
                colors: '#3E4954',
                fontSize: '14px',
    ...
    setTimeout(function () {
      var myChart = new ApexCharts(document.querySelector("#chartBar1"), options);
      myChart.render();
		}, 1000);
    });
  </script>
