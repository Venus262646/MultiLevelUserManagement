	  ...
	  <div class="card">
		...
		<div class="card-body">
		  ...
		  <div id="smartwizard" class="form-wizard order-create">
			...
			<form class="wizard_form form-create-new-movilizador" action="{{ !isset($u_user->id) ? url('/movilizador/create') : url('/movilizador/edit/' . $u_user->id) }}" method="post"  enctype="multipart/form-data">
			  @csrf <!-- {{ csrf_field() }} -->
			  <div class="tab-content">
                        ...
                        <div class="col-lg-6 mb-2">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" id="postal_code_code" name="postal_code_code" class="form-control" data-id="{{ isset($u_user->detail->postal->code)? $u_user->detail->postal->code : old('postal_code_code') }}" value="{{ isset($u_user->detail->postal->code)? $u_user->detail->postal->code : old('postal_code_code') }}" required>
				...
				<div id="wizard_section_3" class="tab-pane" role="tabpanel">
				  <div class="row">
                    ...
                    <div class="col-lg-6 mb-2">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select id="curp" name="edad_result" class="form-control default-select " onchange="onChangeEdad(this.value)">
                                <option {{ isset($u_user->detail->edad) && $u_user->detail->edad == "16" ? "selected" : "" }} value="16">16</option>
                                <option value="17">17</option>
                                <option {{ isset($u_user->detail->edad) && $u_user->detail->edad == "18" ? "selected" : "" }} value="18+">18 +</option>
                              </select>
                          </div>
                        </div>
                    </div>
                    <div class="col-lg-6 mb-2">
                        <div class="form-group">
                          <label class="text-label" id="edad_result"> {{ isset($u_user->detail->edad) && $u_user->detail->edad == "16" ? "CURP *" : "Clave de Elector *" }}</label>
                          <div class="input-group">
                            <div class="input-group-prepend">
                              <span class="input-group-text"> <i class="fa fa-id-card-o"></i> </span>
                            </div>
                            <input type="text" class="form-control" name="edad" value="{{ isset($u_user->detail->edad) ? $u_user->detail->edad == "16" ? $u_user->detail->curp : $u_user->detail->elector_key : old('edad') }}" required>
                          </div>
                        </div>
                      </div>
					<div class="col-lg-6 mb-2">
