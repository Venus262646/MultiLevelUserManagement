                    ...
                    <div class="col-lg-6 mb-2">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="edad" value="{{ isset($u_user->detail->edad) ? $u_user->detail->edad == "16" ? $u_user->detail->curp : $u_user->detail->elector_key : "" }}" required>
                          </div>
                        </div>
                      </div>
					<div class="col-lg-6 mb-2">
