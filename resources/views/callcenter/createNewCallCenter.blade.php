	  ...
	  <div class="card">
		...
		<div class="card-body">
		  <div class="basic-form">
			...
			@endif
			<form class="form-create-new-admin" action="{!! url('/callcenter/create'); !!}" method="post" enctype="multipart/form-data">
			  @csrf <!-- {{ csrf_field() }} -->
			  <div class="row">
				...
				<div class="col-lg-6 mb-2">
				  <div class="form-group">
					...
					<div class="input-group">
					  ...
					  <input type="text" class="form-control" value="{{ old('username') }}" name="username" placeholder="Enter a nick name to be used instead of full name..">
					  <input type="hidden" name="level" value="Call Center">
				...
				<div class="col-lg-6 mb-2">
				  <div class="form-group">
					...
					<div class="input-group">
					  ...
					  <input type="text" class="form-control" name="phone_number" value="{{ old('phone_number') }}" placeholder="Enter a Teléfono.." required>
					</div>
				  </div>
				</div>
				<div class="col-lg-6 mb-2">
				...
				<div class="col-lg-6 mb-2">
				  <div class="form-group">
					...
					<div class="input-group">
					  ...
					  <input type="text" class="form-control" name="phone_number_2" value="{{ old('phone_number_2') }}" placeholder="Enter a Teléfono 2..">
					</div>
				  </div>
				</div>
				<div class="col-lg-6 mb-2">
				  ...
				  <div class="form-group" style="margin-top: 0px;">
					<button type="submit" id="submit_btn" class="btn mr-2 btn-primary">Create New Call Center</button>
