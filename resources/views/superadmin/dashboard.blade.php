      ...
      <div class="card">
        <div class="card-header d-sm-flex d-block pb-0 border-0">
          <div class="mr-auto pr-3 mb-sm-0 mb-3">
            <h4 class="text-black fs-20">Usuraios Chart</h4>
      ...
      <div class="card">
        ...
        <div class="card-body pt-2">
          <div class="testimonial-one owl-carousel">
            @forelse($directs as $user)
            <div class="items">
              <div class="card text-center">
                <div class="card-body">
                  <img src="{{ asset('images/avatar') }}/{{ $user->avatar_url }}" alt="">
                  <h5 class="fs-16 font-w500 mb-1"><a href="{!! url('/profile'); !!}" class="text-black">{{ $user->first_name." ".$user->second_name }}</a></h5>
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    ...
                    <a href="{!! url('/profile'); !!}" class="btn-link fs-14">Send Request</a>
                  </div>
                </div>
              </div>
            </div>
...
@push('scripts')
	<script>
      ...
      var options = {
          series: [{
            name: "Number",
            data: @json(array_values( $users_count ))
          }
        ],
          chart: {
          height: 400,
        ...
        xaxis: {
          categories: @json(array_keys( $users_count )),
		  labels: {
		   style: {
			  colors: '#3E4954',
			  fontSize: '14px',
