	  ...
	  <div class="card">
		...
		<div class="card-body">
		  ...
		  <div id="smartwizard" class="form-wizard order-create">
			...
			<form class="wizard_form form-create-new-seccional" action="{{ !isset($u_user->id) ? url('/seccional/create') : url('/seccional/edit/' . $u_user->id) }}" method="post"  enctype="multipart/form-data">
			  @csrf <!-- {{ csrf_field() }} -->
