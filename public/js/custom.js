...
function smsVerify() {
    ...
    $phone_number_confirm = $("#phone_number_confirm").val();

    if($phone_number != "" && $phone_number_confirm != "" && $phone_number == $phone_number_confirm) {
        $("#sms_button").removeClass("disabled");
    }
    else $("#sms_button").addClass("disabled");
}
