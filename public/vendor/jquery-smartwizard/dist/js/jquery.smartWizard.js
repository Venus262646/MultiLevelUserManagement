    ...
    _createClass(SmartWizard, [{
      ...
      value: function _setEvents() {
        ...
        this.main.find('.sw-btn-next').on("click", function (e) {
          ...
          var fields = form.find('#wizard_section_' + $('#current_wizard').val()).find(":input");
          if (fields.valid()) {
            $('#current_wizard').val(parseInt($('#current_wizard').val()) + 1);
            if(parseInt($('#current_wizard').val()) < 5)
              _this._showNext();
            else {
              $('.wizard_form').submit();
            }
      ...
      value: function _setButtons(idx) {
        ...
        if (!this.options.cycleSteps) {
          ...
          this.main.find('.sw-btn-next').html("Next");
          ...
          switch (this._getStepPosition(idx)) {
            ...
            case 'last':
              ...
              this.main.find('.sw-btn-next').html("Create");
              break;
